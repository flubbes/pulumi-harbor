...
class TasksArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vulnerability_scan_policy: The frequency of the vulnerability scanning is done. Can be to **"hourly"**, **"daily"** or **"weekly"**
        """
...
@pulumi.type_token("harbor:index/tasks:Tasks")
class Tasks(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            vulnerability_scan_policy: pulumi.Input[Optional[_builtins.str]] = None) -> 'Tasks':
        """

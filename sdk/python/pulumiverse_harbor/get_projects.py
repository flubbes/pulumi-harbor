...
def get_projects(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool public: If the project has public accessibility.
    :param _builtins.str type: The type of the project : Project or ProxyCache.
    :param _builtins.bool vulnerability_scanning: If the images will be scanned for vulnerabilities when push to harbor.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_projects_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        public: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                        type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        vulnerability_scanning: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,

...
def get_robot_accounts(level: Optional[_builtins.str] = None,
    ...
    :param _builtins.int project_id: The id of the project within harbor.
    """
    __args__ = dict()
...
def get_robot_accounts_output(level: pulumi.Input[Optional[Optional[_builtins.str]]] = None,

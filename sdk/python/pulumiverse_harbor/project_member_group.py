...
class ProjectMemberGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The group type.  Can be set to `"ldap"`, `"internal"` or `"oidc"`.
        """
...
class ProjectMemberGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'ProjectMemberGroup':
        """

...
public final class ImmutableTagRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ImmutableTagRuleArgs Empty = new ImmutableTagRuleArgs();
    ...
    private ImmutableTagRuleArgs() {}

    private ImmutableTagRuleArgs(ImmutableTagRuleArgs $) {
    ...
    public static Builder builder(ImmutableTagRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImmutableTagRuleArgs();
        }

        public Builder(ImmutableTagRuleArgs defaults) {
            $ = new ImmutableTagRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ImmutableTagRuleArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("ImmutableTagRuleArgs", "projectId");
            }
            return $;
        }
    }

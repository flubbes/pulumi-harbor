...
public final class ConfigAuthState extends com.pulumi.resources.ResourceArgs {

    public static final ConfigAuthState Empty = new ConfigAuthState();
    ...
    private ConfigAuthState() {}

    private ConfigAuthState(ConfigAuthState $) {
    ...
    public static Builder builder(ConfigAuthState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ConfigAuthState defaults) {
            $ = new ConfigAuthState(Objects.requireNonNull(defaults));
        }
